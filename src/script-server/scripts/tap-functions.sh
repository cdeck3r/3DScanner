...
# Source: https://github.com/goozbach/bash-tap-functions
# All credits belong to the original authors.
#
# The functions are copied in this project, because the repo above
# is a loose collection of TAP function for various langs 
# rather than a standalone project for cloning.
#
# Changes: by cdeck3r
# 2021-07-06: add '-e' to diag's echo command to support customized colors
#
